 ...
 *    31.08.2021  3.4.0   UP case updated
 *************************************************************************/
#include <zt_venti_condi.h>

/*  App params  */
const bool DEBUG = true;
const char* APP_VERSION = "3.4.0 (31.08.2021)";
    ...
    if (trend == "Standby") {
      ...
      if (trend == "Up") {
        if (targetCondiLevel > actualCondiLevel) {
          ...
          if (DEBUG) serial_printf(Serial, "\t!!! While UP target level (%i) < actual level (%i) - IGNORE!", targetCondiLevel, actualCondiLevel);
          // do nothing!!! 
